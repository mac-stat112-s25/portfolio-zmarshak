...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9am", y = "Temperature at 3 PM", title = "Temperature in Australian Cities in the Morning vs the Afternoon", color = "Location")  
```
...
ggplot(weather, aes(y = temp3pm, x = temp9am, color = location)) + 
  geom_point() + 
  labs(x = "Temperature at 9 AM", y = "Temperature at 3 PM", color = "City")  
```
