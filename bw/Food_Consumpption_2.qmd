...
ne_countries(returnclass = "sf") |>
  ...
  labs(title = "Food Consumption Around The World")
```
# I copied the code from the test and kept getting errors on my end, so to improve it if it worked like on the exam, I added a color-blind friendly scale as well as added a title. 
